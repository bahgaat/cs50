...
def diet():
    if request.method == "POST":
        ...
        Remainingcalories = float(totalgoalcalories) - float(caloriesconsumed)
        Remainingfats = float(fatsgrams) - float(fatsconsumed)
        Remainingcarbs = float(carbsgrams) - float(carbsconsumed)
        Remainingproteins = float(proteinsgrams) - float(proteinsconsumed)
        
        return render_template("plan.html",Breakfast=dict['Breakfast'],Lunch=dict['Lunch'],Dinner=dict['Dinner'],Snacks=dict['Snacks'],totalcaloriesconsumed=caloriesconsumed,totalgoalcalories=totalgoalcalories,Remainingcalories=Remainingcalories,fatsconsumed=fatsconsumed,totalgoalfat=fatsgrams,Remainingfats=Remainingfats,carbsconsumed=carbsconsumed,totalgoalcarb=carbsgrams,Remainingcarbs=Remainingcarbs,proteinsconsumed=proteinsconsumed,totalgoalprotein=proteinsgrams,Remainingproteins=Remainingproteins)
    else:
        return("diet.html")
